...
export { R2_GET_ENDPOINT, EDUCATION_PATH, EXPERIENCE_PATH, PERSONAL_INFO_PATH, CV_PATH, R2_PUT_ENDPOINT, PAGES_BASE_URL, PAGES_CONTENT_INDEX_URL, PROJECTS_PATH, LOGO_DIR, SCREENSHOT_DIR, PROFILE_PICTURE_PATH, R2_PROFILE_PICTURE }